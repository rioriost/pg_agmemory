...
EXTRACTION_SYSTEM_PROMPT = (
    ...
    "be an exact, nonempty substring of its evidence_quote. A quote that omits the subject "
    "is invalid, even if it contains the predicate and value. For a short single-line source, "
    "copy the entire line as evidence_quote, including the subject. Copy evidence_quote verbatim "
